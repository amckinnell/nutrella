  ...
  RSpec.describe TaskBoard do
    ...
    describe "#new" do
      it "missing configuration" do
        ...
        expect { TaskBoard.new(options, "location") }.to raise_error(RuntimeError, /location does not exist/)
      end
      ...
      it "malformed configuration" do
        ...
        expect { TaskBoard.new(options, "location") }.to raise_error(RuntimeError, /location malformed/)
      end
    end
  end
end
